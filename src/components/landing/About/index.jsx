...
export const About = () => (
    <AboutWrapper as={Container}>
      ...
      <Details>
        ...
        <p>
          My interests include web dev, UI/UX design, and data science. In my spare time, you'll find me reading <Link to="/books" className="highlight-link">good books</Link>,
